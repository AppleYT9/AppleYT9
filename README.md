<div align="center">
  <!-- Standing Natural Color 4K Hero Header Banner -->
  <img src="https://raw.githubusercontent.com/AppleYT9/AppleYT9/main/header-banner-v4.jpg" width="100%" alt="Madhan Senthilkumar Header Banner"/>
  ...
  &nbsp;
  <a href="mailto:madhansenthilkumar1@gmail.com">
...
| :--- | :--- | :--- |
| **Generative AI & RAG** | Dual-Mode RAG, Embeddings, Vector Search, AI Fairness & Bias Auditing, LLM Orchestration | LangChain, ChromaDB, Groq, Llama 3.1, Sentence-Transformers |
| **Causal Inference & A/B** | Propensity Score Matching (PSM), SRM Validation, Heterogeneous Treatment Effects, Bayesian Framing | SciPy, Statsmodels, Python, Jupyter Notebook |
| **Computer Vision & Tracking**| Object Detection, Speed Estimation, Traffic Density Classification, Multi-Object Tracking | YOLOv8, ByteTrack, OpenCV, TensorFlow, Keras, CNN |
| **Explainable ML & Forecasting** | Churn Risk Scoring, Feature Interpretability, Anomaly Detection, Time-Series Demand Forecasting | Scikit-learn, SHAP, Prophet, Isolation Forest, Streamlit |
| **Data Analytics & BI** | EDA, Data Quality Pipelines, KPI Scoring Models, Interactive Dashboarding | Python, Pandas, NumPy, SQL, Power BI, Matplotlib, Seaborn |
| **Backend & Full-Stack** | REST API Architecture, MERN Stack Applications, Interactive Machine Learning Deployments | FastAPI, Streamlit, React, Next.js, TypeScript, Spring Boot |
...
**Description:** An end-to-end causal statistical engine evaluating marketing campaign ad lift across ~588,000 users. Controls for ad-frequency bias using Propensity Score Matching (PSM) and validates sample integrity via Chi-Square SRM checks.

| Attribute | Details |
| :--- | :--- |
| **Stack & Methods** | Python, SciPy, Statsmodels, Propensity Score Matching (PSM), Chi-Square SRM Validation, Bayesian Beta-Binomial Inference |
| **Core Objective** | Quantify true causal conversion lift from ad exposure while neutralizing confounding user variables. |
| **Key Outcomes** | Isolated statistically significant conversion lift using PSM and framed continuous conversion confidence using Bayesian decision intervals. |
| **Repository** | [github.com/AppleYT9/Marketing-Campaign-A-B-Test-Causal-Impact-Analysis](https://github.com/AppleYT9/Marketing-Campaign-A-B-Test-Causal-Impact-Analysis) |
...
**Description:** A production dual-mode Explainable RAG hiring application featuring Candidate Mode (resume vs JD match percentage & skill gap breakdown) and Recruiter Mode (1 JD vs 10 resumes candidate leaderboard with fairness audit layers).

| Attribute | Details |
| :--- | :--- |
| **Stack** | React, FastAPI, LangChain, ChromaDB, Groq / Llama 3.1 LLM, Sentence-Transformers |
| **Key Features** | Vector embeddings semantic search, skill gap extraction, candidate ranking leaderboard, and bias/fairness auditing layer. |
| **Live Demo & Code** | [Live Demo (Render)](https://fitcheck-rag.onrender.com/) • [GitHub Repository](https://github.com/AppleYT9/Fitcheck-RAG-) |
...
**Description:** An end-to-end computer vision pipeline using YOLOv8 and ByteTrack to detect vehicles and pedestrians, calculate speed vectors, classify congestion density tiers, and log traffic violations to SQLite.

| Attribute | Details |
| :--- | :--- |
| **Stack** | Python, YOLOv8, ByteTrack, OpenCV, SQLite |
| **Core Features** | Multi-object detection & tracking, frame-by-frame velocity estimation, real-time density classification, and automated violation logging. |
| **Repository** | [github.com/AppleYT9](https://github.com/AppleYT9) |
...
**Description:** A real-time churn risk-scoring engine (81.5% accuracy) segmenting 7,000+ Telco customers into risk tiers with SHAP feature attribution to explain exact customer churn drivers.

| Attribute | Details |
| :--- | :--- |
| **Stack & Tools** | Python, Scikit-learn, SHAP Explainability, Plotly, Streamlit |
| **Key Features** | Interactive churn probability dashboard, SHAP waterfall plots explaining individual customer risk, and automated retention recommendations. |
| **Live Demo** | [Streamlit App](https://customer-churn-prediction-gjimgav4xtmnycgpcvzujg.streamlit.app/) |
...
**Description:** An automated data profiling and cleaning application designed to streamline dataset preprocessing and ensure high data quality before model training or analytics.

| Attribute | Details |
| :--- | :--- |
| **Stack** | Next.js, React, TypeScript, Pandas, Vercel |
| **Key Features** | CSV/XLS upload, missing-value detection, duplicate row identification, IQR & Z-score outlier detection, automated profiling, and cleaned dataset export. |
| **Live Demo & Code** | [Live Demo (Vercel)](https://data-sanitizer-pro-l7lb.vercel.app/) • [GitHub Repository](https://github.com/AppleYT9/DataSanitizer-Pro) |
...
**Description:** An AI-powered smart ride and personal-safety platform designed to improve transportation accessibility and safety for women, elderly users, and persons with disabilities (PWD).

| Attribute | Details |
| :--- | :--- |
| **Stack** | MERN Stack (MongoDB, Express, React, Node.js), Firebase, Random Forest ML, OSRM, OpenStreetMap |
| **Key Features** | Geospatial safety scoring, Pink Safety Mode, Elderly Support Mode, PWD Accessibility Mode, live tracking, and emergency SOS alerts. |
| **Repository** | [github.com/AppleYT9/safego-design-system](https://github.com/AppleYT9/safego-design-system) |
...
**Description:** An end-to-end analytics platform executing SQL RFM customer segmentation (K-Means), Isolation Forest anomaly detection, and Prophet time-series sales demand forecasting.

| Attribute | Details |
| :--- | :--- |
| **Stack** | Python, SQL, FastAPI, Scikit-learn, Prophet, Isolation Forest, Power BI |
| **Key Insights** | Categorized customer segments using RFM metrics, isolated transactional outliers, and predicted seasonal retail demand curves. |
...
**Description:** A computer vision CNN classifier (~85% accuracy) evaluating satellite imagery to identify flood-impacted regions for early disaster response.

| Attribute | Details |
| :--- | :--- |
| **Stack** | Python, TensorFlow, Keras, CNN, Satellite Imagery Analysis |
| **Approach** | Binary image classification and spatial feature extraction for environmental monitoring. |
...
| :--- | :--- | :--- |
| **AWS Certified Developer – Associate** | Infosys Springboard | Certified |
| **IBM – Python for Data Science** | IBM | 2025 |
| **Oracle – Agentic AI Certified Foundations Associate** | Oracle | Certified |
| **Anthropic – Claude Code 101** | Anthropic | Certified |
| **HackerRank – SQL (Advanced) Certificate** | HackerRank | Certified |
| **Deloitte Australia – Data Analytics Job Simulation** | Deloitte Australia | 2024 |
| **NPTEL – Computer Networks** | NPTEL | Certified |
...
<div align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/AppleYT9/AppleYT9/output/github-contribution-grid-snake-dark.svg">
    <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/AppleYT9/AppleYT9/output/github-contribution-grid-snake.svg">
    <img alt="GitHub Contribution Grid Snake" src="https://raw.githubusercontent.com/AppleYT9/AppleYT9/output/github-contribution-grid-snake-dark.svg">
  </picture>
</div>
